...
<head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="/AnimeFilmWeb/vnpay_assets/bootstrap.min.css" rel="stylesheet"/>
    <!-- Custom styles for this template -->
    <link href="/AnimeFilmWeb/vnpay_assets/jumbotron-narrow.css" rel="stylesheet">
    <script src="/AnimeFilmWeb/vnpay_assets/jquery-1.11.3.min.js"></script>
</head>
<body>
<%
...
<div class="container">
    ...
    <div class="table-responsive">
        ...
        <button id="registerButton" type="button" class="btn btn-primary">Home</button>
    </div>
    <p>
        &nbsp;
    </p>
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        home.addEventListener("click", function (event) {
            ...
            window.location.href = "http://localhost:8080/AnimeFilmWeb/home";
